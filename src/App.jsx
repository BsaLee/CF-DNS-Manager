...
import { Globe, Server, User, Key, LogOut, Plus, Trash2, Edit2, ExternalLink, RefreshCw, Zap, Languages, CheckCircle, AlertCircle, Search, ChevronDown, Upload, Download } from 'lucide-react';
...
const translations = {
    zh: {
        ...
        errorOccurred: '发生错误',
        yourDomains: '您的域名',
        domainSubtitle: '选择一个域名以管理其 DNS 记录',
        refresh: '刷新',
        id: 'ID',
        manage: '管理',
        back: '返回列表',
    ...
    en: {
        ...
        domainSubtitle: 'Select a zone to manage its DNS records',
        refresh: 'Refresh',
        id: 'ID',
        manage: 'Manage',
        back: 'Back to Zones',
